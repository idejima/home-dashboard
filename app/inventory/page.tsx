  ...
  return (
    <PageShell>
      <header className="page-header">
        ...
        <p className="page-subtitle">Track where everything lives in your home.</p>
      </header>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          <BoxIcon />
          {search ? `No items matching "${search}"` : "No items yet — add your first one."}
        </div>
      ) : (
              ...
              {editingId === item.id ? (
                <div className="edit-row">
                  <input
                    ...
                    style={{ maxWidth: 220 }}
                  />
                  <button className="btn btn-primary btn-sm" onClick={() => saveEdit(item.id)} disabled={editSaving}>
